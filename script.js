...
const categories = [
  {label:"Cooking Gas",icon:"fas fa-fire",img:"/images/gas.jpg"},
  {label:"Gas Cylinders",icon:"fas fa-cylinder",img:"/images/gas3kg.jpg"},
  {label:"Gas Burners",icon:"fas fa-fire-flame-curved",img:"/images/burner.jpg"},
  {label:"Gas Accessories",icon:"fas fa-wrench",img:"/images/ring-2.jpg"},
  {label:"Kitchen Utensils",icon:"fas fa-utensils",img:"/images/plates-on-gas.jpg"},
  {label:"Kitchen Utensils",icon:"fas fa-utensils",img:"/images/plates.jpg"},
  {label:"Kitchen Utensils",icon:"fas fa-utensils",img:"/images/plates1.jpg"},
  {label:"Cookware",icon:"fas fa-pot-food",img:"/images/stuffs.png"},
  {label:"gas cylinders",icon:"fas fa-wheat-awn",img:"/images/stuff-1.jpg"},
  {label:"Provisions",icon:"fas fa-box-open",img:"/images/stuff-2.jpg"},
];

const products = [
  {id:1,cat:"gas",badge:"Best Seller",title:"3kg Gas Cylinder",desc:"Compact and portable 3kg LPG cylinder. Perfect for small homes and offices.",price:"₦17,000",img:"/images/gas3kg.jpg"},
  {id:2,cat:"gas",badge:"Popular",title:"6kg Gas Cylinder",desc:"Standard 6kg LPG cylinder for average household use. Refillable.",price:"₦25,000",img:"/images/gas-3.jpg"},
  {id:5,cat:"gas",badge:"",title:"12.5kg Gas Cylinder",desc:"Large household cylinder. Long-lasting supply for big families and businesses.",price:"₦26,500",img:"/images/gas12.5.png"},
  {id:4,cat:"gas",badge:"New",title:"Single Burner Gas Cooker",desc:"Portable tabletop gas burner. Ideal for small kitchens and outdoor cooking.",price:"₦12,000",img:"/images/burner.jpg"},
  {id:5.1,cat:"gas",badge:"",title:"Table cooker",desc:"High-quality pressure regulator with safety valve. Fits all standard cylinders.",price:"₦280,000",img:"/images/table-cooker.jpg"},
  {id:6,cat:"gas",badge:"",title:"Electric-Gas",desc:"High-quality pressure regulator with safety valve. Fits all standard cylinders.",price:"₦3,500",img:"/images/electric2.jpg"},
   {id:3,cat:"gas",badge:"",title:"Oven cooker",desc:"Large household cylinder. Long-lasting supply for big families and businesses.",price:"₦45,000",img:"/images/coal-gas.jpg"},
  {id:6,cat:"kitchen",badge:"Popular",title:"Non-Stick Cooking Pot Set",desc:"5-piece non-stick pot set with tempered glass lids. Dishwasher safe.",price:"₦18,500",img:"/images/spoons.jpg"},
  {id:7,cat:"kitchen",badge:"",title:"Stainless Steel Frying Pan",desc:"Premium stainless frying pan with anti-scorch base. Even heat distribution.",price:"₦7,200",img:"/images/plates2.jpg"},
  {id:8,cat:"kitchen",badge:"New",title:"Kitchen Utensil Set (12pc)",desc:"Complete 12-piece kitchen tool set: ladles, turners, spatulas and more.",price:"₦5,500",img:"/images/plates1.jpg"},
  {id:9,cat:"food",badge:"",title:"Premium Basmati Rice (5kg)",desc:"Fragrant, long-grain basmati rice. Imported quality, parboiled and clean.",price:"₦9,800",img:"/images/rice-bags.jpg"},
  {id:9,cat:"food",badge:"",title:"Premium Basmati Rice (5kg)",desc:"Fragrant, long-grain basmati rice. Imported quality, parboiled and clean.",price:"₦9,800",img:"/images/rice.jpg"},
